...
/* other intersect variation and equivalence */
select sId, cName from apply where major="CS"
intersect
select sId, cName from apply where major="EE";

select distinct a1.sid, a1.cName
from apply a1, apply a2
where a1.sid = a2.sid and a1.major = "CS" and a2.major = "EE" and a1.cname = a2.cname;
