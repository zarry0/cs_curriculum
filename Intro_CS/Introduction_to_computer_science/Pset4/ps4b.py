...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(len(letters)):
            index = ((shift + i) - 26) if (shift + i) > 25 else (shift + i)
            shift_dict[letters[i]] = letters[index]
            shift_dict[letters[i].upper()] = letters[index].upper()
        return shift_dict
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for s in range(26):
            ...
            if max_count == count:
                ans = (s, message)
            if max_count == len(message.split()):
                break
        return ans
...
if __name__ == '__main__':
    ...
    print('                  Test case 1 (Ciphertext)')
    ciphertext = CiphertextMessage('jgnnq, yqtnf')
    print('Expected Output:', (24, 'hello, world'))
    print('Actual Output:', ciphertext.decrypt_message(), end = '\n\n')

    #Test case 2 (Plaintext)
    print('                  Test case 2 (Plaintext)')
    plaintext = PlaintextMessage('Dog god', 4)
    print('Expected Output: Hsk ksh')
    print('Actual Output:', plaintext.get_message_text_encrypted(), end = '\n\n')

    #Test case 2 (CiphertextMessage)
    print('                  Test case 2 (Ciphertext)')
    ciphertext = CiphertextMessage('Hsk ksh')
    print('Expected Output:', (22, 'Dog god'))
    print('Actual Output:', ciphertext.decrypt_message(), end = '\n\n')
