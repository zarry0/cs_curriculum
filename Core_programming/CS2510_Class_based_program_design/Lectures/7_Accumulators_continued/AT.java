...
interface IAT { 
    ...
    IAT youngestGrandparent();
    // produces the youngest ancestor of this, n generations ago
    IAT youngestAnc(int n);
...
class Unknown implements IAT {
    ...
    // produces the youngest ancestor of this, n generations ago
    public IAT youngestAnc(int n) { return new Unknown(); }
...
class Person implements IAT {
    ...
    public IAT youngestGrandparent() {
        return  this.youngestAnc(2);
    }
    // produces the youngest ancestor of this, n generations ago
    public IAT youngestAnc(int n) { 
        if (n <= 0) return this;
        return this.mom.youngestAnc(n-1).youngest(this.dad.youngestAnc(n-1));
    }
