...
; With that in mind, let's look at using encapsulation with a sorting example
; similar to what you saw in the arrange-images problem from the Function Composition lecture.
;
