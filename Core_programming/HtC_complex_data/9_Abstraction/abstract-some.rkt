...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname abstract-some) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; produce true if pred produces true for some of the elements of lox
