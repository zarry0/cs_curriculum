...
(define (sum-data e)
  (local [(define (c1 n d lon) (+ d lon))
          (define (c2 n lon) (+ n lon))]
    (fold-element c1 c2 0 e)))
...
(define (all-names e)
  (local [(define (c1 n d los) (cons n los))]
          ;(define (c2 los los2) (append los los2))]
...
;; The way the fold-element function is designed doesn't allow for the improvements for
;; backtracking search we made in the last week. So it will be inefficient because currently there's
;; no way of avoiding recomputation in that abstract function
