...
;; an abstract function to combine a list of images into a single image
(check-expect (arrange-all beside (list (circle 10 "outline" "red") (circle 20 "outline" "blue") (circle 10 "outline" "yellow")))
              (beside (circle 10 "outline" "red") (circle 20 "outline" "blue") (circle 10 "outline" "yellow")))
(check-expect (arrange-all above (list (circle 10 "outline" "red") (circle 20 "outline" "blue") (circle 10 "outline" "yellow")))
              (above (circle 10 "outline" "red") (circle 20 "outline" "blue") (circle 10 "outline" "yellow")))

(define (arrange-all pred loi)
  (cond [(empty? loi) empty-image]
        [else
         (pred (first loi)
               (arrange-all pred (rest loi)))]))
...
;; (String Z Y -> X) (X Y -> Y) Z Z Z Z Z Y Region -> X
